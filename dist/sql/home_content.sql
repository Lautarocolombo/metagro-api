-- Tabla principal: textos editables del homepage
...
-- Datos iniciales (INSERT ... ON CONFLICT para no duplicar)
INSERT INTO home_content (id, valor, categoria, descripcion) VALUES
  ...
  ('hero_subtitle', 'Insumos ganaderos, alambrados y herramientas para tu estancia o chacra.', 'hero', 'Subtítulo/descripción del hero'),
  ('hero_btn_products', 'VER PRODUCTOS', 'hero', 'Texto botón ver productos'),
  ('hero_btn_contact', 'CONTACTARNOS', 'hero', 'Texto botón contactarnos'),
  ('hero_years', '43 AÑOS EN', 'hero', 'Texto badge años en el mercado'),
